...
const UserRiskProfile = ({ walletAddress, riskScore, onTierSelect }: { walletAddress: any; riskScore: any; onTierSelect?: any }) => {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <div className="space-y-3">
            {Object.entries(tierAccess).map(([tier, access]: [string, any]) => (
              <div
                key={tier}
