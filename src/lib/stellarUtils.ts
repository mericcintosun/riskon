...
export class AdvancedSorobanClient {
  ...
  async makeRpcCall(method, params = null) {
    try {
      const requestBody: { jsonrpc: string; id: number; method: any; params?: any } = {
        jsonrpc: "2.0",
        id: this.requestId++,
        method,
      };
...
export class EnhancedPoolManager {
  contractManager: StellarContractManager;
  client: AdvancedSorobanClient;
...
export class StellarBlendIntegration {
  poolManager: EnhancedPoolManager;
  contractManager: StellarContractManager;
