...
export const getRiskData = async (address) => {
  return dbInstance.getRiskData(address);
};

export const deleteRiskData = async (address) => {
 ...
 */
export const exportRiskData = async () => {
  try {
 ...
 */
export const importRiskData = async (file) => {
  return new Promise((resolve, reject) => {
