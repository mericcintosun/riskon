...
// Deprecated: the JavaScript implementation in storage/db.js is the single source of truth
// for default imports. This module keeps its named exports for type/util consumers only.