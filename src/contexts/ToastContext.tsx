...
interface ToastValue {
  ...
  promise: (promise: Promise<any>, messages?: { loading?: string; success?: string; error?: string }) => void;
  dismiss: (toastId?: string) => void;
  custom: (jsx: ReactNode, options?: ToastOptions) => void;
  categorizeError: (error: any) => { type: string; icon: ReactNode };
  showCategorizedError: (error: any, customMessage?: string) => void;
  showIssueReport: (issues: string[]) => void;
}
...
export function ToastProvider({ children }: ToastProviderProps) {
  const showToast: ToastValue = {
    ...
    showCategorizedError: (error: any, customMessage: string | null = null) => {
      const category = showToast.categorizeError(error);
      const errorMessage = error?.message || error || "Unknown error";
